...
namespace Zork
{
    ...
    internal class Program
    {
      ...
      private static readonly Room[,] Rooms = {
         {new Room("RockyTrail"), new Room("South of House"), new Room("Canyon View") },
        ...
        private static void InitializeRoomDescription()
        {
            ...
            Rooms[1, 2].Description = "You are behind a white house. In one corner of the house there is a small window which is slightly ajar.";       // Behind House
